...
<body>
	<h1>주문/결제</h1>
	 <form action="${pageContext.request.contextPath }/order/productOrder" method="post">
	<div>
		<table>
			<tr>
				<th>수령인</th>
			...
			<tr>
				...
				<td><input type="text" class="form-control"
					oninput="oninputPhone(this)" maxlength="14" name="phone" id="phone"></td>
			</tr>
			<tr>
				<th>우편번호</th>
				<td>
				<input type="text" placeholder="우편변호"  name="addressNumber" id="addressNumber"/> 
			...
			<tr>
				<th>주소</th>
				<td>
				<input type="text" placeholder="배송주소" name="addressInfo" id="addressInfo" /> 
				<input type="text" placeholder="상세주소1" name="addressDetail" id="addressDetail"/>
				<input type="text" placeholder="상세주소2" name="addressDetail2" id = "addressDetail2"/>
				</td>
			</tr>
			</table>
			</div>
